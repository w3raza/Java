...
class Main {
	public static void main(String[] args) {
		// BasicAccount basicAccount = new BasicAccount("Adam Abacki", 1234.56, "0000");
		// //error: BasicAccount is abstract; cannot be instantiated
		RegularAccount regularAccount = new RegularAccount("Adam Abacki", 1234.56, "0000");
		RegularAccount regularAccount1 = new RegularAccount("Adam Abacki", 1234.56, "0000");
		RegularAccount regularAccount2 = new RegularAccount("Adam", 1234.56, "0000");

		System.out.println("equals " + regularAccount.equals(regularAccount1)); // true
		System.out.println("equals " + regularAccount.equals(regularAccount2)); // false
